...
run_DEMO_EXPERIMENTS()
{
  ...
  train_MVTEC $SAVE_IMAGES N_ALL $RESULTS_PATH 7 1000 70 0.05 1 1 True  1 10 True True  True  "${GPUS[@]}"
  ...
  # train_single $SAVE_IMAGES STEEL $STEEL_PATH ALL_1000_N_250 $RESULTS_PATH 1 1000 250 50 0.1 0.1 10 True  2 1 True  True  True  ${GPUS[0]}
